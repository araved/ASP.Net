...
namespace MVCFlowerShop.Views
{
    public class FlowersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FlowerName,FlowerProducedDate,Type,Price")] Flower flower)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FlowerName,FlowerProducedDate,Type,Price")] Flower flower)
        {
            if (id != flower.ID)
            {
                return NotFound();
